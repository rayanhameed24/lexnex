                ...
                {!isVideoPlaying ? (
                  ...
                  <div className="w-full h-full bg-black flex items-center justify-center">
                    <div className="text-white text-center">
                      ...
                      <div className="text-gray-400">
                        Our introduction video is in production
                      </div>
                      <button
                        ...
                        {isSubmitted ? (
                          ...
                          <form onSubmit={handleSubmit} className="space-y-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
                              ...
                              <div>
                                <label htmlFor="email" className="text-left block text-sm font-medium text-gray-300 mb-2">
                                  Email Address
                                </label>
                                <input
                                  type="email"
                            ...
                            <div>
                              <label htmlFor="subject" className=" text-left block text-sm font-medium text-gray-300 mb-2">
                                Subject
                              </label>
                              <select
                                id="subject"
                            ...
                            <div>
                              <label htmlFor="message" className="text-left block text-sm font-medium text-gray-300 mb-2">
                                Message
                              </label>
                              <textarea
                                id="message"
